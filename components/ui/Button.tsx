...
export function Button({ variant = "primary", size = "md", icon: Icon, children, className = "", ...rest }: ButtonProps) {
  ...
  const variants = {
    // slate-900 on amber-500 measures 8.31:1. White on the same amber is
    // 2.15:1 and fails AA badly — keeping the brand colour and darkening the
    // label is what fixes it without shifting the accent used everywhere else.
