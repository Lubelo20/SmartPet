import { Bell, Brain, ClipboardList, Cpu, Gauge, LayoutDashboard, PawPrint, Radio, Settings, Users, Utensils, type LucideIcon } from "lucide-react";
...
export const NAV: NavItem[] = [
  ...
  { key: "ai", href: "/ai", label: "AI model", icon: Brain, title: "AI model", subtitle: "The pet identification model: metrics, dataset notes, and a live test bench." },
